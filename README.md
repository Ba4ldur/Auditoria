...
│   │   ├── auditorias/         # lista, nova, workspace e relatório
│   │   ├── importacoes/
│   │   ├── divergencias/       # tabela com filtros + painel de evidências
│   │   ├── regras/             # configuração por regra
│   │   ├── relatorios/
│   │   └── configuracoes/
│   ├── api/                    # upload, processamento, download, dados de demonstração
│   └── login/
├── components/
...
└── lib/
    ...
    │   ├── engine.ts  tolerance.ts  revenue.ts  score.ts  types.ts
...
## 11. Como adicionar uma regra de auditoria
